...
def get_user_details(user_id,db):
        ...
        if user.exists:
            ...
            return {'client_title':client_title,'edit_frame':edit_frame,'text_coordinates':text_coordinates,'text_color':text_color,'text_size':text_size,'text':text}
...
# Calculate the x-coordinate of the center of the text
                ...
                y_coordinates={}
                for key in data.keys():
                        x_coordinates[key]=int(text_coordinates_dict[key][0]*width)
                        y_coordinates[key]=int(text_coordinates_dict[key][1]*height)
